...
{
    public enum GameModes { Title, HeroSelect, WalkingToNextEncounter, EncounterIntro, EncounterInspection, EncounterRollingLocking, EncounterActionResolution, EncounterOutcome}
